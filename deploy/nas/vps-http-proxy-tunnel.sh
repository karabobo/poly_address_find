...
LOCAL_PROXY_HOST="${PM_ROBOT_PROXY_LOCAL_HOST:-172.19.0.1}"
...
KEY_PATH="${PM_ROBOT_VPS_KEY_PATH:-/volume1/docker/pm-robot/ssh/id_ed25519_pmrobot_vps}"
LOG_PATH="${PM_ROBOT_PROXY_TUNNEL_LOG_PATH:-/volume1/docker/pm-robot/logs/vps-http-proxy-tunnel.log}"
