...
RUNTIME_ROOT="${PM_ROBOT_NAS_ROOT:-$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)}"
KEY_PATH="${PM_ROBOT_TUNNEL_KEY_PATH:-$RUNTIME_ROOT/ssh/id_ed25519_pmrobot_vps}"
LOG_PATH="${PM_ROBOT_TUNNEL_LOG_PATH:-$RUNTIME_ROOT/logs/reverse-tunnel.log}"
